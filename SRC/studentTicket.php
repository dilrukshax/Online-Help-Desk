...
<body>
    ...
    <div style="min-height: 600px; margin-top: 100px;">
        ...
        <h1 style="margin-top: 100px; font-size: 30px;"> My Tickets </h1>
        <?php

        // Retrieve tickets data from the database $_SESSION['student_name']['S_ID'] 
        $sql = "SELECT * FROM tickets WHERE status = '0' AND `user_id`='" . $_SESSION['student']['ID'] . "' ";
        $result = mysqli_query($conn, $sql);

        // Check if there are any tickets
        if (mysqli_num_rows($result) > 0) {
            echo "<table border: 1px solid black >";
            echo "<tr><th>Student id</th><th>Student Name</th><th>email</th><th>faculties</th><th>phone</th><th>subject</th><th>msg</th></tr>";
